...
const outcomeJourneys = [
  {
    ...
    time: 'about 8 min',
    href: '/learn/safe-agentic-coding/',
  },
  {
    label: 'Plan work',
    ...
    time: 'about 12 min',
    href: '/start/spec-driven-development/',
  },
  {
    label: 'Specify',
...
export default function FromPrincipleToAction(): ReactNode {
  return (
    <Layout
      title="From principle to governed action"
